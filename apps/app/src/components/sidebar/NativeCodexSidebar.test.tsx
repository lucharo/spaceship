  ...
  sessions: [
    {
      ...
      repositoryUrl: "https://github.com/lucharo/spaceship.git",
      status: "active",
    ...
    vi.mocked(sdk.providers.nativeSessions).mockResolvedValue({
      ...
      sessions: [
        ...
        },
        {
          ...
          projectId: null,
          workspaceRoot: "/Users/demo/.codex/worktrees/a1b2/spaceship",
          repositoryUrl: "https://github.com/lucharo/spaceship.git",
        ...
        },
        {
          ...
          repositoryUrl: "https://github.com/acme/another-project.git",
